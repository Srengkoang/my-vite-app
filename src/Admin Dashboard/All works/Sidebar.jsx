...
const Sidebar = ({ currentView, setView, adminName }) => {
    const navItems = [
    ...
    return (
        <div className="flex flex-col h-full p-4" style={{ backgroundColor: COLORS.lightGreen }}>
            ...
            <h3 className="text-sm font-mono font-medium uppercase text-gray-500 mb-2 mt-4 ml-4">My Profile</h3>
            ...
            <h3 className="text-sm font-mono font-medium uppercase text-gray-500 mb-2 mt-4 ml-4">Admin Options</h3>
